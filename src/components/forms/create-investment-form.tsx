      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <DialogContent className="sm:max-w-md">
                  <DialogHeader>
                    <DialogTitle>Add Investment Type</DialogTitle>
                    <DialogDescription>
                      Create a new investment type to categorize your
                      investments.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    <div>
                      <Input
                        placeholder="e.g., Cryptocurrency, Bonds, Art"
                        value={newTypeName}
            ...
            <FieldDescription>
              What type of investment is this? Click the + button to add a
              custom type.
            </FieldDescription>
            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
          </Field>
